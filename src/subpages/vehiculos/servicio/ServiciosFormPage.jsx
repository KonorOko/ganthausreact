...
export function ServiciosFormPage({ setActualizar, actualizar, link }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    if (params.id) {
      try {
        await AwaitToast({
          promise: updateServicio(params.id, data),
        ...
        {params.id && (
          <button
            ...
            onClick={async () => {
              ...
              if (accepted) {
                await AwaitToast({
                  promise: deleteServicio(params.id),
